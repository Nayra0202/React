...
export default function Edit() {
  ...
  const [kaprodi, setKaprodi] = useState(""); // Menginisialisasi state 'nama' untuk menyimpan nama prodi
  const [singkatan, setSingkatan] = useState(""); // Menginisialisasi state 'nama' untuk menyimpan nama prodi
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(`https://academic-mi5a.vercel.app/api/api/prodi/${id}`, { nama, kaprodi, singkatan,
        fakultas_id: fakultas,}) // Mengirimkan request PATCH untuk mengupdate data prodi berdasarkan ID
      .then((response) => {
